(function (global, factory) {
     ...
     */
    function indexOfNewline(string, offset, includeLength) {
        if (offset === void 0) { offset = 0; }
        if (includeLength === void 0) { includeLength = false; }
        if (offset < 0)
            throw new Error('Unexpected negative offset');
        if (offset > string.length)
            throw new Error("Offset is longer than the string. Offset: ".concat(offset, ". String: ").concat(string.length));
